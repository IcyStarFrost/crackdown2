...
ENT.PrintName = "Ingalls AL-107 Cell Soldier"

if CLIENT then language.Add( "cd2_107cellsoldier", "Ingalls AL-107 Cell Soldier" ) end
...
ENT.cd2_Weapon = "cd2_ingallsal107" -- The weapon this NPC will have
