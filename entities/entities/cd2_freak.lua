...
function ENT:CanAttack( ent )
    return ( ( ent:IsCD2NPC() or ent:IsCD2Agent() ) and ent:GetCD2Team() != self:GetCD2Team() or ( ent.cd2_IsBeaconPart and ent:GetOwner():GetIsCharging() and ( ( ent:GetOwner().cd2_curtimeduration - CurTime() ) < ent:GetOwner():GetChargeDuration() * 0.40 ) ) ) and self:CanSee( ent )
end
