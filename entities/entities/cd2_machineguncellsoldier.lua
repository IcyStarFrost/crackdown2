...
ENT.PrintName = "Machine Gun Cell Soldier"

if CLIENT then language.Add( "cd2_machineguncellsoldier", "Machine Gun Cell Soldier" ) end

ENT.cd2_Health = 200 -- The health the NPC has
...
ENT.cd2_Weapon = "cd2_machinegun" -- The weapon this NPC will have
