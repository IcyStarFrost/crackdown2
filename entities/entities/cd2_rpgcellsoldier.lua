...
ENT.PrintName = "RPG Cell Soldier"

if CLIENT then language.Add( "cd2_rpgcellsoldier", "RPG Cell Soldier" ) end
...
ENT.cd2_Weapon = "cd2_rocketlauncher" -- The weapon this NPC will have
