...
ENT.PrintName = "Demp 90-A Cell Soldier"

if CLIENT then language.Add( "cd2_shotguncellsoldier", "Demp 90-A Cell Soldier" ) end
...
ENT.cd2_Weapon = "cd2_demp90a" -- The weapon this NPC will have
